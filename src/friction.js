      ...
      <div class="friction__stage" role="region" aria-label="地面与箱子">
        <div class="stage" data-stage>
          ...
          <div class="bear" data-bear aria-hidden="true">
            <div class="bear__sprite" data-bear-sprite aria-hidden="true">
              <div class="bear__head"></div>
              <div class="bear__ear bear__ear--left"></div>
              <div class="bear__ear bear__ear--right"></div>
              <div class="bear__eye bear__eye--left"></div>
              <div class="bear__eye bear__eye--right"></div>
              <div class="bear__snout"></div>
              <div class="bear__nose"></div>
              <div class="bear__mouth"></div>
              <div class="bear__body"></div>
              <div class="bear__arm bear__arm--top"></div>
              <div class="bear__arm bear__arm--bottom"></div>
              <div class="bear__leg bear__leg--left"></div>
              <div class="bear__leg bear__leg--right"></div>
              <div class="bear__sweat"></div>
            </div>
          </div>
        </div>
...
function updateBearUI() {
  ...
  const pushing = isRunning && autoForceN > 0
...
// (Motion bear animation is implemented earlier; legacy Lottie functions removed.)
